...
namespace SentimentModel.ConsoleApp
{
    public partial class SentimentModel
    {
        public const string RetrainFilePath =
            @"/Users/1000064565/Documents/Repositories/MLNetExamples/NLNetExamples.SentimentModel/yelp_labelled.txt";
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName: @"col0", outputColumnName: @"col0")
                ...
                .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(
                    binaryEstimator: mlContext.BinaryClassification.Trainers.LbfgsLogisticRegression(
                        ...
                        {
                            L1Regularization = 0.03125F, L2Regularization = 0.03125F, LabelColumnName = @"col1",
